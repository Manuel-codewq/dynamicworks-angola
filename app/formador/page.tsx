        ...
        <div style={{ background: "#111827", border: `1px solid ${areaInfo.color}30`, borderRadius: 14, padding: 24, marginBottom: 24 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {area === "trading" && (<>
              ...
              <div style={{ marginBottom: 14 }}><label style={lbl}>Pares negociados</label><input type="text" value={pares} onChange={e => setPares(e.target.value)} placeholder="Ex: nomes dos pares negociados" style={inp} /></div>
