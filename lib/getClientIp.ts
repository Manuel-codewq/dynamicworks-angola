 ...
 *
 * NOTA: x-forwarded-for NÃO é usado como fallback — o primeiro IP pode ser
 * falsificado pelo cliente para contornar rate limits.
 *
...
export function getClientIp(req: NextRequest): string {
  ...
  // Sem proxy de confiança reconhecido: não há forma segura de obter o IP real
  return "unknown";
}
