...
// Ordem e valores de `label` preservados byte-a-byte a partir de
// CRYPTO_PAIRS (lib/derivWebSocket.ts) / ALL_PAIRS (lib/settings.ts) —
// confirmado idêntico nas duas fontes antes desta migração.
